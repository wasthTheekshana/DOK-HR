    ...
    return (
        <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-slate-900">Sites &amp; Locations</h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-9 pr-9 py-2.5 border-2 border-slate-200 rounded-xl focus:outline-none focus:border-indigo-400 transition-colors text-sm w-56"
                        />
                        {search && (
                                ...
                                {viewingSite.TASK_TYPES && viewingSite.TASK_TYPES.length > 0 && (
                                    <div>
                                        <h3 className="text-sm font-bold text-slate-700 mb-2 flex items-center gap-1.5">
                                            <DollarSign className="w-4 h-4 text-indigo-500" /> Task Types &amp; Invoice Prices
                                        </h3>
