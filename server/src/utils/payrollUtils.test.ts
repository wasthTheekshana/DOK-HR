...
describe('Payroll Calculations', () => {
    describe('Time Based OT', () => {
        ...
        test('should calculate extra hours correctly for 2.5 hours (rounds to 3)', () => {
            // 19:30 - 17:00 = 2.5 hours -> rounds to 3
            expect(calculateTimeBasedExtra('19:30', DEFAULT_OUT)).toBe(3);
        });

        test('should calculate extra hours correctly for 2.4 hours (rounds to 2)', () => {
            // 19:24 - 17:00 = 2.4 hours -> rounds to 2
            // 2h 24m = 2.4h
        ...
        test('should handle exactly half round up', () => {
            // 17:30 - 17:00 = 0.5 -> 1
            expect(calculateTimeBasedExtra('17:30', DEFAULT_OUT)).toBe(1);
        });
